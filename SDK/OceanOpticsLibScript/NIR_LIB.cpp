...
bool openSpectrometers(void)							// 查找连接的所有光谱仪
{
...
void setCorrectForDetectorNonlinearity(bool x)
{
	GetInstance( );
	/*---------------------------------------------------------------------------------------------------------------
...
void setCorrectForElectricalDark(bool x)
{
	GetInstance( );
	/*---------------------------------------------------------------------------------------------------------------
...
bool getSpectrum(double **wavelengths, double **spectrum, int *number)
{
